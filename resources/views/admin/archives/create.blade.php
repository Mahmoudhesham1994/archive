...
<!--                <input class="form-control date {{ $errors->has('arc_date') ? 'is-invalid' : '' }}" type="date" name="arc_date" id="arc_date" value="{{ old('arc_date') }}" required>-->
             <input class="form-control date {{ $errors->has('arc_date') ? 'is-invalid' : '' }}" type="text" name="arc_date" id="arc_date" value="{{ old('arc_date') }}" required  >
...
<!--
      ...
      <div class="col-sm-10">
       <div class="input-group">
        ...
        <input class="form-control" id="arc_date" name="arc_date" placeholder="MM/DD/YYYY" type="text"/>
       </div>
      </div>
     </div>
-->
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('arc_title') ? 'is-invalid' : '' }}" type="text" name="arc_title" id="arc_title" value="{{ old('arc_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('arc_subject') ? 'is-invalid' : '' }}" name="arc_subject" id="arc_subject">{{ old('arc_subject') }}</textarea>
...
//    	$(document).ready(function(){
//		var date_input=$('input[name="arc_date1"]'); //our date input has the name "date"
//		var container=$('.bootstrap-iso form').length>0 ? $('.bootstrap-iso form').parent() : "body";
//		date_input.datepicker({
//			format: 'dd/mm/yyyy',
//			container: container,
