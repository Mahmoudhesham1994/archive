    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.priorities.update", [$priority->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('priority_desc') ? 'is-invalid' : '' }}" type="text" name="priority_desc" id="priority_desc" value="{{ old('priority_desc', $priority->priority_desc) }}" required>
