...
<!--                <label class="required" for="password">New {{ trans('cruds.user.fields.password') }}</label>-->
                <label class="required" for="password">  {{ trans('cruds.user.fields.password') }}{{trans('global.New')}}</label>
...
<!--                <label class="required" for="password_confirmation">Repeat New {{ trans('cruds.user.fields.password') }}</label>-->
              ...
              <label class="required" for="password_confirmation"> {{trans('global.Repeat_New')}}  {{ trans('cruds.user.fields.password') }}
