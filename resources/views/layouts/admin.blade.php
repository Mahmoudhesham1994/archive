...
<head>
    ...
    <title>{{ trans('panel.site_title') }}</title>
      ...
      <link href="{{ asset('public/rtl/css2/select2.min.css') }}" rel="stylesheet" />
     <link href="{{ asset('public/rtl/css2/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" />
     <link href="{{ asset('public/rtl/css/adminltev3.css') }}" rel="stylesheet" />
    <link href="{{ asset('public/rtl/css2/all.css') }}" rel="stylesheet" />
    <link href="{{ asset('public/rtl/css2/cssfont.css') }}" rel="stylesheet" />
<!--     <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet" />-->
     <link href="{{ asset('public/rtl/css2/jquery.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('public/rtl/css2/dataTables.bootstrap4.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('public/rtl/css2/select.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('public/rtl/css2/buttons.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('public/rtl/css2/dropzone.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('public/rtl/css/custom.css') }}" rel="stylesheet" />
    
    
     <link href="{{ asset('public/rtl/css2/bootstrap.min.css') }}" rel="stylesheet" />
   <link rel="stylesheet" href="{{ asset('public/rtl/dist/css/custom.css') }}">
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        ...
        @include("partials0.NavBar")
        @include("partials0.SideBar")
       ...
       <script src="{{ asset('public/rtl/js2/jquery.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/bootstrap.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/popper.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/select2.full.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/moment.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/dataTables.bootstrap4.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/dataTables.buttons.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/dataTables.select.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/buttons.flash.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/buttons.html5.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/buttons.print.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/buttons.colVis.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/pdfmake.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/vfs_fonts.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/jszip.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/ckeditor.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/moment2.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/bootstrap-datetimepicker.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/select23.full.min.js') }}"></script>
    <script src="{{ asset('public/rtl/js2/dropzone.min.js') }}"></script>
     <script src="{{ asset('public/rtl/js/main.js') }}"></script>
