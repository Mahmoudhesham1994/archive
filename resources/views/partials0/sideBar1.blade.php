        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               <li class="nav-item">
                ...
                @endcan
                    ...
                    <li class="nav-item has-treeview {{ request()->is('admin/asset-categories*') ? 'menu-open' : '' }} {{ request()->is('admin/asset-locations*') ? 'menu-open' : '' }} {{ request()->is('admin/asset-statuses*') ? 'menu-open' : '' }} {{ request()->is('admin/assets*') ? 'menu-open' : '' }} {{ request()->is('admin/assets-histories*') ? 'menu-open' : '' }} {{ request()->is('admin/parts*') ? 'menu-open' : '' }} {{ request()->is('admin/assets-parts*') ? 'menu-open' : '' }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            ...
                            @can('part_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.parts.index") }}" class="nav-link {{ request()->is('admin/parts') || request()->is('admin/parts/*') ? 'active' : '' }}">
                                        ...
                                        <p>
                                            <span>{{ trans('cruds.part.title') }}</span>
                                        </p>
                                    </a>
                                </li>
                            @endcan
                            @can('assets_part_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.assets-parts.index") }}" class="nav-link {{ request()->is('admin/assets-parts') || request()->is('admin/assets-parts/*') ? 'active' : '' }}">
                                        <i class="fa-fw fas fa-cogs">

                                        </i>
                                        <p>
                                            <span>{{ trans('cruds.assetsPart.title') }}</span>
                                        </p>
                                    </a>
                                </li>
                            @endcan
                ...
                @endcan
               @can('support_order_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.support-orders.index") }}" class="nav-link {{ request()->is('admin/support-orders') || request()->is('admin/support-orders/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-cogs">

                            </i>
                            <p>
                                <span>{{ trans('cruds.supportOrder.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
